...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provider/providerlist">
				...
				<a href="${pageContext.request.contextPath }/provider/proadd">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/providerlist.js" charset="utf-8"></script>
