...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/bills/billList">
			...
			<input type="hidden" name="pageIndex" value="1"/>
			 ...
			 <a href="${pageContext.request.contextPath }/bills/toadd">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/billlist.js" charset="utf-8"></script>